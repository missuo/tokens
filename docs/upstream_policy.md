...
| Hosting | Self-hosted Docker, Postgres in a container on the same host | Cloudflare Workers via OpenNext; Neon Postgres in `us-west-2` behind Hyperdrive, Worker pinned to the same region |
