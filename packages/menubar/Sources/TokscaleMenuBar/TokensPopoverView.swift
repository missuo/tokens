...
private struct HistorySection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 11) {
            ...
            HistoryTotalCard(
                cost: model.allTimeCost,
                tokens: model.allTimeTokens,
                days: model.allTimeDays
            )
            ...
            HStack(spacing: 8) {
                ...
                HistoryStatPill(
                    title: model.dailyAverage.title,
                    value: model.dailyAverage.value,
                    detail: model.dailyAverage.detail
                )
            }
...
private struct HistoryTotalCard: View {
    let cost: String
    let tokens: String
    let days: String
