...
export function QuickstartSection() {
  const tui = useCopy("bunx tokens-cli@latest");
  const submit = useCopy("bunx tokens-cli@latest submit");
  const {
        ...
        >
          ...
          <QuickstartCard $position="left">
            ...
            <CardContent>
              ...
              <CommandBox>
                <CommandInputArea>
                  <CommandText>bunx tokens-cli@latest</CommandText>
                  <GradientAccent />
                </CommandInputArea>
          ...
          <QuickstartCard $position="right">
            ...
            <CardContent>
              ...
              <CommandBox>
                <CommandInputArea>
                  <CommandText>bunx tokens-cli@latest submit</CommandText>
