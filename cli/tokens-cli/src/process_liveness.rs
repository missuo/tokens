...
pub fn pid_is_alive(pid: u32) -> bool {
    // PID 0 is the kernel/idle process on every platform tokens ships to,
...
mod imp {
    ...
    /// `errno` values for `kill`, identical across the Unix targets tokens
    /// builds.
    const EPERM: i32 = 1;
    const ESRCH: i32 = 3;
...
mod imp {
    ...
    pub(super) fn pid_is_alive(_pid: u32) -> bool {
        ...
        // tokens releases — all of them are Unix or Windows.
