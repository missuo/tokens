...
//!
//! Parses usage files cached locally at ~/.config/tokens/cursor-cache/.
...
/// One row of `usageEventsDisplay`. Only the fields tokens consumes are
...
"2026-08-18T12:00:00.000Z","On-Demand","gpt-5","No","10","5","20","3","38","-$0.50""#;
    ...
    fn test_parse_cursor_events_json_prefers_total_cents_over_charged_cents() {
        // When the two diverge the metered cost is what tokens reports, the
