    ...
    pub fn resolve_with_env_strategy(&self, home_dir: &str, use_env_roots: bool) -> String {
        match self {
            ...
            PathRoot::Config => {
                ...
                join_home(home_dir, ".config/tokens")
            }
            PathRoot::AppData => {
...
define_clients!(
    OpenCode = 0 => {
        id: "opencode",
        display: "OpenCode",
        logo: Some("https://tokens.ci/clients/client-opencode.png"),root: PathRoot::XdgData,
    ...
    Claude = 1 => {
        id: "claude",
        display: "Claude Code",
        logo: Some("https://tokens.ci/clients/client-claude.jpg"),root: PathRoot::EnvVar {
    ...
    Codex = 2 => {
        id: "codex",
        display: "Codex CLI",
        logo: Some("https://tokens.ci/clients/client-openai.jpg"),root: PathRoot::EnvVar {
            var: "CODEX_HOME",
    ...
    Cursor = 3 => {
        id: "cursor",
        display: "Cursor IDE",
        logo: Some("https://tokens.ci/clients/client-cursor.jpg"),root: PathRoot::Home,
    ...
    Gemini = 4 => {
        id: "gemini",
        display: "Gemini CLI",
        logo: Some("https://tokens.ci/clients/client-gemini.png"),root: PathRoot::EnvVar {
            var: "GEMINI_CLI_HOME",
    ...
    Amp = 5 => {
        id: "amp",
        display: "Amp",
        logo: Some("https://tokens.ci/clients/client-amp.png"),root: PathRoot::XdgData,
    ...
    Droid = 6 => {
        id: "droid",
        display: "Droid",
        logo: Some("https://tokens.ci/clients/client-droid.png"),root: PathRoot::Home,
    ...
    Pi = 8 => {
        id: "pi",
        display: "Pi",
        logo: Some("https://tokens.ci/clients/client-pi.png"),root: PathRoot::Home,
    ...
    Kimi = 9 => {
        id: "kimi",
        display: "Kimi CLI",
        logo: Some("https://tokens.ci/clients/client-kimi.png"),root: PathRoot::Home,
    ...
    Qwen = 10 => {
        id: "qwen",
        display: "Qwen CLI",
        logo: Some("https://tokens.ci/clients/client-qwen.png"),root: PathRoot::Home,
    ...
    RooCode = 11 => {
        id: "roocode",
        display: "Roo Code",
        logo: Some("https://tokens.ci/clients/client-roocode.png"),root: PathRoot::Home,
    ...
    KiloCode = 12 => {
        id: "kilocode",
        display: "Kilo Code",
        logo: Some("https://tokens.ci/clients/client-kilocode.png"),root: PathRoot::Home,
    ...
    Mux = 13 => {
        id: "mux",
        display: "Mux",
        logo: Some("https://tokens.ci/clients/client-mux.png"),root: PathRoot::Home,
    ...
    Kilo = 14 => {
        id: "kilo",
        display: "Kilo CLI",
        logo: Some("https://tokens.ci/clients/client-kilocode.png"),root: PathRoot::XdgData,
    ...
    Crush = 15 => {
        id: "crush",
        display: "Crush",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-crush.png"),root: PathRoot::XdgData,
    ...
    Hermes = 16 => {
        ...
        logo: Some("https://tokens.ci/clients/client-hermes.png"),root: PathRoot::EnvVar {
            var: "HERMES_HOME",
    ...
    Copilot = 17 => {
        id: "copilot",
        display: "Copilot CLI",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-copilot.jpg"),root: PathRoot::Home,
    ...
    Goose = 18 => {
        id: "goose",
        display: "Goose",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-goose.png"),root: PathRoot::XdgData,
    ...
    Codebuff = 19 => {
        id: "codebuff",
        display: "Codebuff",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-codebuff.png"),root: PathRoot::EnvVar {
    ...
    Antigravity = 20 => {
        id: "antigravity",
        display: "Antigravity",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-antigravity.png"),root: PathRoot::Config,
    ...
    Zed = 21 => {
        id: "zed",
        display: "Zed Agent",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-zed.webp"),root: PathRoot::XdgData,
    ...
    Jcode = 28 => {
        id: "jcode",
        display: "Jcode",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-jcode.png"),root: PathRoot::EnvVar {
            var: "JCODE_HOME",
    ...
    AntigravityCli = 31 => {
        ...
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-antigravity.png"),root: PathRoot::EnvVar {
            var: "GEMINI_CLI_HOME",
            fallback_relative: ".gemini",
        },
    ...
    Freebuff = 44 => {
        id: "freebuff",
        display: "Freebuff",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-freebuff.png"),root: PathRoot::EnvVar {
    ...
    // `mcode exec --output-format stream-json`. Tokens captures those
    ...
    Fx = 48 => {
        id: "fx",
        display: "Fx",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-fx.png"),
        root: PathRoot::Home,
    ...
    // synchronized by `tokens hindsight sync`.
    Hindsight = 52 => {
        id: "hindsight",
        display: "Hindsight",
        logo: Some("https://raw.githubusercontent.com/missuo/tokens/main/.github/assets/client-hindsight.png"),
        root: PathRoot::EnvVar {
            var: "HINDSIGHT_HOME",
...
mod tests {
    ...
    // `TOKENS_CONFIG_DIR` on the way out, which is a *clear* when the
    ...
    // the real `~/.config/tokens/cache` took the write. One domain is the
    ...
    fn canonical_client_brand_labels_and_logos_are_registered() {
        ...
        assert_eq!(
            ...
            Some("https://tokens.ci/clients/client-opencode.png")
        );
    }
    ...
    fn test_reasonix_stats_expands_environment_references_before_normalizing_paths() {
        let mut env = EnvGuard::capture(&[
            "REASONIX_STATE_HOME",
            "TOKENS_REASONIX_TEST_ROOT",
            "TOKENS_REASONIX_TEST_UNSET",
        ]);
        let client = ClientId::Reasonix;

        env.set("TOKENS_REASONIX_TEST_ROOT", "~/reasonix-state");
        env.remove("TOKENS_REASONIX_TEST_UNSET");
        env.set(
            "REASONIX_STATE_HOME",
            "${TOKENS_REASONIX_TEST_ROOT}/nested",
        );
        assert_eq!(
            client.data().resolve_path(reasonix_home()),
            reasonix_stats_under(native_join(
        ...
        env.set(
            "REASONIX_STATE_HOME",
            "${TOKENS_REASONIX_TEST_UNSET:-relative-reasonix}",
        );
        let expected = reasonix_stats_under(
            std::env::current_dir()
                .expect("test process has a current directory")
    ...
    fn test_path_root_config_ignores_env_when_disabled() {
        ...
        let expected = if cfg!(target_os = "windows") {
            ...
            native_join(std::path::Path::new("/tmp/home"), ".config/tokens")
        };
    ...
    /// Every `tokens.ci/clients/client-<file>` logo must be backed by a file
    ...
    fn test_hosted_logo_urls_have_a_committed_asset() {
        const HOSTED_PREFIX: &str = "https://tokens.ci/clients/client-";
